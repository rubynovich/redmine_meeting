...
#  end
  ...
  def participator_meeting_notice(participator)
    if participator && participator.sended_notice_on.present?
      if participator.saw_protocol_on.present?
  ...
  def participator_attendance(participator)
